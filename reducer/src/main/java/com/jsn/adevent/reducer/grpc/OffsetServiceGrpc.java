...
public final class OffsetServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.jsn.adevent.reducer.grpc.Offset,
      com.jsn.adevent.reducer.grpc.Empty> getSendOffsetMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SendOffset",
      requestType = com.jsn.adevent.reducer.grpc.Offset.class,
      responseType = com.jsn.adevent.reducer.grpc.Empty.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.jsn.adevent.reducer.grpc.Offset,
      com.jsn.adevent.reducer.grpc.Empty> getSendOffsetMethod() {
    io.grpc.MethodDescriptor<com.jsn.adevent.reducer.grpc.Offset, com.jsn.adevent.reducer.grpc.Empty> getSendOffsetMethod;
      ...
      synchronized (OffsetServiceGrpc.class) {
        if ((getSendOffsetMethod = OffsetServiceGrpc.getSendOffsetMethod) == null) {
          OffsetServiceGrpc.getSendOffsetMethod = getSendOffsetMethod =
              io.grpc.MethodDescriptor.<com.jsn.adevent.reducer.grpc.Offset, com.jsn.adevent.reducer.grpc.Empty>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SendOffset"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.jsn.adevent.reducer.grpc.Offset.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void sendOffset(com.jsn.adevent.reducer.grpc.Offset request,
  ...
  public static final class OffsetServiceStub
     ...
     * </pre>
     */
    public void sendOffset(com.jsn.adevent.reducer.grpc.Offset request,
        io.grpc.stub.StreamObserver<com.jsn.adevent.reducer.grpc.Empty> responseObserver) {
  ...
  public static final class OffsetServiceBlockingStub
     ...
     * </pre>
     */
    public com.jsn.adevent.reducer.grpc.Empty sendOffset(com.jsn.adevent.reducer.grpc.Offset request) {
  ...
  public static final class OffsetServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.jsn.adevent.reducer.grpc.Empty> sendOffset(
        com.jsn.adevent.reducer.grpc.Offset request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEND_OFFSET:
          serviceImpl.sendOffset((com.jsn.adevent.reducer.grpc.Offset) request,
              (io.grpc.stub.StreamObserver<com.jsn.adevent.reducer.grpc.Empty>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.jsn.adevent.reducer.grpc.Offset,

...
public final class AdClickEventServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.jsn.adevent.mapper.grpc.AdEventMap,
      com.jsn.adevent.mapper.grpc.Empty> getSendEventMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SendEvent",
      requestType = com.jsn.adevent.mapper.grpc.AdEventMap.class,
      responseType = com.jsn.adevent.mapper.grpc.Empty.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.jsn.adevent.mapper.grpc.AdEventMap,
      com.jsn.adevent.mapper.grpc.Empty> getSendEventMethod() {
    io.grpc.MethodDescriptor<com.jsn.adevent.mapper.grpc.AdEventMap, com.jsn.adevent.mapper.grpc.Empty> getSendEventMethod;
      ...
      synchronized (AdClickEventServiceGrpc.class) {
        if ((getSendEventMethod = AdClickEventServiceGrpc.getSendEventMethod) == null) {
          AdClickEventServiceGrpc.getSendEventMethod = getSendEventMethod =
              io.grpc.MethodDescriptor.<com.jsn.adevent.mapper.grpc.AdEventMap, com.jsn.adevent.mapper.grpc.Empty>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SendEvent"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.jsn.adevent.mapper.grpc.AdEventMap.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void sendEvent(com.jsn.adevent.mapper.grpc.AdEventMap request,
  ...
  public static final class AdClickEventServiceStub
     ...
     * </pre>
     */
    public void sendEvent(com.jsn.adevent.mapper.grpc.AdEventMap request,
        io.grpc.stub.StreamObserver<com.jsn.adevent.mapper.grpc.Empty> responseObserver) {
  ...
  public static final class AdClickEventServiceBlockingStub
     ...
     * </pre>
     */
    public com.jsn.adevent.mapper.grpc.Empty sendEvent(com.jsn.adevent.mapper.grpc.AdEventMap request) {
  ...
  public static final class AdClickEventServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.jsn.adevent.mapper.grpc.Empty> sendEvent(
        com.jsn.adevent.mapper.grpc.AdEventMap request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEND_EVENT:
          serviceImpl.sendEvent((com.jsn.adevent.mapper.grpc.AdEventMap) request,
              (io.grpc.stub.StreamObserver<com.jsn.adevent.mapper.grpc.Empty>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.jsn.adevent.mapper.grpc.AdEventMap,
